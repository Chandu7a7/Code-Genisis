...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        const getUserDetails = async () => {
            ...
            try {
                const res = await axios.get("https://code-genisis-backend-c8461405o-chandus-projects-d19e03f3.vercel.app/profile/getuserdetails" , {withCredentials : true}) ; 
        ...
        const FetchHistory = async () => {
            ...
            try {
                const res = await axios.get("https://code-genisis-backend-c8461405o-chandus-projects-d19e03f3.vercel.app/user/usagehistory" , {withCredentials : true} ); 
                if(res.data.success){
    ...
    const deleteFavHandler = async (id) => {
        ...
        try {
            const res = await axios.put("https://code-genisis-backend-c8461405o-chandus-projects-d19e03f3.vercel.app/user/deletefavourite" , {id : id} , {withCredentials : true} ); 
    ...
    const LogoutHandler = async () => {
        ...
        try {
            const res = await axios.get("https://code-genisis-backend-c8461405o-chandus-projects-d19e03f3.vercel.app/auth/logout" , {withCredentials: true}) ;
