...
const CodeExplainer = () => {
  ...
  const FetchChart = async () => {
    ...
    try {
      ...
      const res = await axios.post("https://code-genisis-backend-qtxpwmosv-chandus-projects-d19e03f3.vercel.app/ai/get-response" , 
  ...
  const AddToFavourite = async () => {
    try {
      const res = await axios.post("https://code-genisis-backend-qtxpwmosv-chandus-projects-d19e03f3.vercel.app/user/addfavourite" , {code : code , response : response} , {withCredentials : true}) ; 
